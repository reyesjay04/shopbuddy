...
<div class="form-group">
    ...
    <div class="form-group row">
     ...
     <div class="form-group">
      ...
      <textarea name="short_desc" id="" cols="30" rows="3" class="form-control" value=""><?php echo htmlentities($short_desc); ?></textarea>
    </div>
...
<!-- 
    <div class="form-group">
          ...
          <hr>
        <input type="number" name="product_tags" class="form-control">
    </div> -->
